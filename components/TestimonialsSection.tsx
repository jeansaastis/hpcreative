...
export default function TestimonialsSection({testimonials}: {testimonials: Testimonial[]}) {
  ...
  return (
    <section className="w-full py-5 px-6 bg-white relative overflow-hidden">
      ...
      <h2 className="font-display font-bold mb-6 text-5xl relative z-10">HP:sta sanottua</h2>
      ...
      <ul className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 relative z-10">
        {testimonials.map((t, idx) => {
          ...
          return (
            <li key={t._id || idx}>
              <article className="relative rounded-[.5rem] p-5 md:p-6 min-h-[180px] flex flex-col text-black overflow-hidden">
                ...
                <div className="mt-4">
                  ...
                  {t.role && <div className="text-sm text-black/70">{t.role}</div>}
                </div>
              </article>
            </li>
          )
